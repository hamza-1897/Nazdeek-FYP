...
export default function Categories() {
  ...
  return (
    <div className="p-8 max-w-6xl w-full mx-auto space-y-6">
      ...
      <section className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm shadow-slate-100/50">
        <h2 className="text-base font-bold text-[#0f172a] mb-4">Add New Category</h2>
        <form onSubmit={handleAddCategory} className="flex gap-4">
          <input 
            ...
            className="flex-1 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#6366f1] focus:ring-2 focus:ring-indigo-50 transition-all placeholder:text-slate-400"
          />
          <button 
            type="submit"
            className="bg-[#94a3b8] hover:bg-[#64748b] text-white font-medium text-sm px-5 py-2.5 rounded-xl flex items-center gap-2 transition-colors shadow-sm"
          >
            <Plus size={18} />
            Add Category
          </button>
