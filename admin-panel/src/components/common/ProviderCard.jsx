  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-all duration-200 min-h-[220px]">
      ...
      <button
        ...
        className="w-full mt-2 cursor-pointer bg-[#1a5ea1] hover:bg-[#154c82] text-white font-semibold text-xs lg:text-sm py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-sm "
      >
        <Eye size={14} />
        View Details
      </button>
