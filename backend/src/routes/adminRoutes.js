...
// provider routes
const {getAllProviders ,getProviderById, updateProvider, getAllReports, updatePayment ,getProviderDetails ,resolveReport, deleteReport } = require('../controllers/admin/admin-providerController');
